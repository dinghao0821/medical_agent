...
# NOTE: docling imports are deferred to parse_document() to avoid DLL load
# failures on systems where the native docling_parse extension is blocked
# by application-control policies (e.g. Windows AppLocker).
...
class MedicalDocParser:
    ...
    def parse_document(
        ...
        """
        # Lazy import — only load docling when actually parsing a document
